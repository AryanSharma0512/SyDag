...
/** The field name as a menu button. Shared by the dashboard and the Data Explorer. */
export function FieldSelector({ fields, field, onSelectField }: FieldSelectorProps) {
